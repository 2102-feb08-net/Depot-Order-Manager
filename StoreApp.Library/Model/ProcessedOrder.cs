...
namespace StoreApp.Library.Model
{
    ...
    public class ProcessedOrder : IReadOnlyOrder
    {
        ...
        /// <param name="orderLines">The orderlines of the order.</param>
        /// <param name="orderTime">The date and time of the order</param>
        /// <param name="id">The order number id</param>
        public ProcessedOrder(ICustomer customer, ILocation storeLocation, List<IOrderLine> orderLines, DateTimeOffset orderTime, decimal totalPrice, int id)
        {
